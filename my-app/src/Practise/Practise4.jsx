...
function Practise4(props) {
    ...
    return (
        <div>
            ...
            <form action="" onSubmit={submitFormJoin}>
                <input value={roomJoin} onChange={e => SetRoomJoin(e.target.value)} type="text" placeholder='Room Join' />
